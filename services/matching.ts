  ...
  (_socket, packet, sendPacket) => {
    switch (packet.header) {
      ...
      case SNSLobbyPingResponseHeader: {
        console.log(arrayBufferToHexString(packet.payload));
